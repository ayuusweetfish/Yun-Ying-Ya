...
// I2S clock is generated by the timer (LEDC),
// I2S peripheral acts as slave through probing pins
...
void i2s_init()
{
  ...
  rx_std_cfg.slot_cfg.slot_mask = (PIN_I2S_LR_VAL ? I2S_STD_SLOT_RIGHT : I2S_STD_SLOT_LEFT);
