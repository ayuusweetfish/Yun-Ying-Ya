...
程序以 Lua 语言编写，你可以调用以下函数，不要使用 \`os\` 库。动画的速度不要太快，特别是避免过快频率的闪烁；在合适的地方加入等待，尽量使大部分段落都能持续三秒以上，为观众留出观察与体会的时间。请细心地选取合适的颜色，以更好地传达你的想法。
...
- breath(r, g, b, n, t): 交替色呼吸——在当前颜色与指定颜色 (r, g, b) 之间往返呼吸 n 次，每次周期为 t 毫秒，最后回到当前颜色。
